...
{
    public partial class RCMCI_with_ReHeating_Optimization_Analysis_Results : Form
    {
        RCMCI puntero_aplicacion;

        public RCMCI_with_ReHeating_Optimization_Analysis_Results(RCMCI puntero1)
        {
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 200), 11000 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc2_out2 / 1.5), 18000 });
                    ...
                    {
                        puntero_aplicacion.luis.RecompCycle_RCMCI_with_Reheating(puntero_aplicacion.luis, ref cicloRCMCI_withRH, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_mc2_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht_in2, variables[3], variables[2], puntero_aplicacion.p_mc2_out2, variables[1], puntero_aplicacion.t_mc1_in2, variables[2],
                        puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2, puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2, puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2,
                        ...
                        -puntero_aplicacion.dp11_pc1, -puntero_aplicacion.dp12_pc1, -puntero_aplicacion.dp2_phx1, -puntero_aplicacion.dp2_phx2, -puntero_aplicacion.dp2_rhx1, -puntero_aplicacion.dp2_rhx2, -puntero_aplicacion.dp11_pc2, -puntero_aplicacion.dp12_pc2);
            ...
            else if (checkBox2.Checked == true)
            {
                ...
                {
                    solver.SetLowerBounds(new[] { 0.1, initial_CIP_value, (initial_CIP_value + 200), 11000, 0.2 });
                    solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc2_out2 / 1.5), 18000, 0.8 });
                    ...
                    Func<double[], double> funcion = delegate (double[] variables)
                    {
                        puntero_aplicacion.luis.RecompCycle_RCMCI_with_Reheating_for_Optimization(puntero_aplicacion.luis, ref cicloRCMCI_withRH, puntero_aplicacion.w_dot_net2,
                        puntero_aplicacion.t_mc2_in2, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht_in2, variables[3], variables[2], puntero_aplicacion.p_mc2_out2, variables[1], puntero_aplicacion.t_mc1_in2, variables[2],
                        variables[4], UA_Total, puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2, puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2,
                        variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1, -puntero_aplicacion.dp2_ht2,
                        -puntero_aplicacion.dp11_pc1, -puntero_aplicacion.dp12_pc1, -puntero_aplicacion.dp2_phx1, -puntero_aplicacion.dp2_phx2, -puntero_aplicacion.dp2_rhx1, -puntero_aplicacion.dp2_rhx2, -puntero_aplicacion.dp11_pc2, -puntero_aplicacion.dp12_pc2);
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "RCMCI_with_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            for (double j = Convert.ToDouble(textBox11.Text); j <= Convert.ToDouble(textBox10.Text); j = j + Convert.ToDouble(textBox9.Text))
            {
                ...
                for (double i = Convert.ToDouble(textBox57.Text); i <= Convert.ToDouble(textBox56.Text); i = i + Convert.ToDouble(textBox55.Text))
                {
                    ...
                    if (checkBox2.Checked == false)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 4, 0.01, 10000))
                        {
                            solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, (initial_mc1_in_value + 200), 11000 });
                            solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc2_out2 / 1.5), 18000 });

                            solver.SetInitialStepSize(new[] { 0.05, 100, 100, 500 });

                            var initialValue = new[] { 0.2, initial_mc1_in_value, initial_mc1_out_value, 11000 };

                            Func<double[], double> funcion = delegate (double[] variables)
                            {
                                puntero_aplicacion.luis.RecompCycle_RCMCI_with_Reheating(puntero_aplicacion.luis, ref cicloRCMCI_withRH, puntero_aplicacion.w_dot_net2,
                                i, puntero_aplicacion.t_t_in2, puntero_aplicacion.t_rht_in2, variables[3], variables[2], puntero_aplicacion.p_mc2_out2, variables[1], i, variables[2],
                                puntero_aplicacion.ua_lt2, puntero_aplicacion.ua_ht2, puntero_aplicacion.eta2_mc2, puntero_aplicacion.eta_rc2, puntero_aplicacion.eta1_mc2, puntero_aplicacion.eta_t2, puntero_aplicacion.eta_trh2, puntero_aplicacion.n_sub_hxrs2,
                                variables[0], puntero_aplicacion.tol2, puntero_aplicacion.eta_thermal2, -puntero_aplicacion.dp2_lt1, -puntero_aplicacion.dp2_lt2, -puntero_aplicacion.dp2_ht1, -puntero_aplicacion.dp2_ht2,
                                -puntero_aplicacion.dp11_pc1, -puntero_aplicacion.dp12_pc1, -puntero_aplicacion.dp2_phx1, -puntero_aplicacion.dp2_phx2, -puntero_aplicacion.dp2_rhx1, -puntero_aplicacion.dp2_rhx2, -puntero_aplicacion.dp11_pc2, -puntero_aplicacion.dp12_pc2);
                                ...
                                HT_Eff_list.Add(cicloRCMCI_withRH.HT.eff);
                                LT_Eff_list.Add(cicloRCMCI_withRH.LT.eff);
                    ...
                    else if (checkBox2.Checked == true)
                    {
                        ...
                        using (var solver = new NLoptSolver(algorithm_type, 5, 0.01, 10000))
                        {
                            solver.SetLowerBounds(new[] { 0.1, initial_mc1_in_value, (initial_mc1_in_value + 200), 11000, 0.2 });
                            solver.SetUpperBounds(new[] { 1.0, 125000, (puntero_aplicacion.p_mc2_out2 / 1.5), 18000, 0.8 });

                            solver.SetInitialStepSize(new[] { 0.05, 100, 100, 500, 0.05 });

                            var initialValue = new[] { 0.2, initial_mc1_in_value, initial_mc1_out_value, 11000, 0.5 };
                            ...
                            //PHX_Q2_list.Add(cicloRCMCI_withRH.PHX.Q_dot);
                            //PHX_Q2_list.Add(cicloRCMCI_withRH.RHX.Q_dot);
            ...
            //Closing Excel Book
            xlWorkBook1.SaveAs(textBox3.Text + "CIT_Optimization_RCMCI_with_ReHeating_" + xlWorkSheet1.Name + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue1, misValue1, misValue1, misValue1, Excel.XlSaveAsAccessMode.xlExclusive, misValue1, misValue1, misValue1, misValue1, misValue1);
        ...
        private void RCMCI_with_ReHeating_Optimization_Analysis_Results_Load(object sender, EventArgs e)
        {
            textBox1.Text = puntero_aplicacion.textBox34.Text;
        }
    }
}
