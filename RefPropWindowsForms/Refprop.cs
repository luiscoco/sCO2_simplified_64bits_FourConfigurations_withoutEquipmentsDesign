...
namespace sc.net
{
    ...
    public class Refprop
    {
        ...
        //public string hfmix = "C:\\Users\\luisc\\Desktop\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\RefPropWindowsForms\\RefPropWindowsForms\\bin\\Debug\\fluids\\HMX.BNC";
        public string hfmix = "HMX.BNC";
        ...
        public double wm, tc, pc, Dc;	//  INFO variables  cached 
        //protected double wm, ttp, tnbp, tc, pc, Dc, Zc, acf, dip, Rgas;	//  INFO variables  cached 

        public double temperature, pressure, density, quality, internalenergy, enthalpy, entropy,
        ...
        //public string FluidsDirectory = "C:\\Users\\luis\\Desktop\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\RefPropWindowsForms\\RefPropWindowsForms\\fluids\\";
        public string FluidsDirectory = "\\fluids\\";
        public string FluidsPath_LCE;
        //public string MixturesDirectory = "C:\\Users\\luis\\Desktop\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\RefPropWindowsForms\\RefPropWindowsForms\\mixtures\\";
        public string MixturesDirectory = "\\mixtures\\";
        //public const string refpropDLL_path = "C:\\Users\\luis\\Desktop\\sCO2 Heat Balances C#\\sCO2 Heat Balances C#\\RefPropWindowsForms\\RefPropWindowsForms\\REFPROP.dll";
        //public const string refpropDLL_path = "REFPRP64.dll";
        public const string refpropDLL_path = "REFPRP64.dll";
        ...
        * located there.            
        *************************************************************/
        [DllImport(refpropDLL_path, EntryPoint = "SETPATHdll", SetLastError = true)]
...
//c      hjt--isenthalpic Joule-Thompson coefficient [K/kPa]
        ...
        public static extern void TRNPRPdll(ref double t, ref double d, double[] x, ref double eta, ref double tcx,
            ref Int32 ierr, [Out, MarshalAs(UnmanagedType.LPStr)]StringBuilder HERR, Int32 LengthHERR);
        ...
        /// 
        protected void LoadFluid(string FileName, Int32 NumberOfComponents, double[] mole_x,string hrf,string arguLUIS)
        {
            try
            {
                ...
                if (arguLUIS == "noMEZCLA")
                {
                    FileName = FluidsPath_LCE + FileName;
                }
                else
                {
                }
                ...
                SETPATHdll(hpath, ref size);

                SETUPdll(ref NumberOfComponents, FileName, hfmix, hrf, ref ierr, herr, 5100, 255, 3, 255);

                //SATSPLNdll(MoleFractions, ref ierr1, ref herr1, ref herrleng1);
                //if (ierr1 != 0)
                //{
                //    MessageBox.Show(herr1, "RefProp SATSPLNdll() Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //    return;
                //}
                //if (ierr1 > 0) throw new Exception(herr1.ToString());
        ...
        protected void TPFLSH(double temp, double pres)
        {
            ...
            try
            {
                TPFLSHdll(ref temperature, ref pressure, MoleFractions, ref density, ref densityofliquidphase, ref this.densityofvaporphase,
                            XLIQ, XVAP, ref quality, ref internalenergy, ref enthalpy, ref entropy, ref cv, ref cp, ref speedofsound,
                            ref ierr, herr, 255);
                TRNPRPdll(ref temperature, ref density, MoleFractions, ref viscosity, ref thermalconductivity, ref ierr, herr, 255);
