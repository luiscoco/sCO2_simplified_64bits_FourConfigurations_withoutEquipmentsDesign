...
{
    public partial class PCRC_without_ReHeating : Form
    {
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            ...
            luis.RecompCycle_PCRC_without_Reheating(luis, ref cicloPCRC_withoutRH, w_dot_net2, t_mc_in2, t_t_in2, p_mc_in2, p_mc_out2, p_pc_in2, t_pc_in2, p_pc_out2, 
            ua_lt2, ua_ht2, eta_mc2, eta_rc2, eta_pc2, eta_t2, n_sub_hxrs2, recomp_frac2, tol2, eta_thermal2, -dp2_lt1, -dp2_lt2, -dp2_ht1, -dp2_ht2, -dp2_pc1, -dp2_pc2, 
            ...
            massflow2 = cicloPCRC_withoutRH.m_dot_turbine;
            w_dot_net2 = cicloPCRC_withoutRH.W_dot_net;
            eta_thermal2 = cicloPCRC_withoutRH.eta_thermal;
            eta_thermal2 = cicloPCRC_withoutRH.eta_thermal;
            recomp_frac2 = cicloPCRC_withoutRH.recomp_frac;           

            temp21 = cicloPCRC_withoutRH.temp[0];
            temp22 = cicloPCRC_withoutRH.temp[1];
            temp23 = cicloPCRC_withoutRH.temp[2];
            temp24 = cicloPCRC_withoutRH.temp[3];
            temp25 = cicloPCRC_withoutRH.temp[4];
            temp26 = cicloPCRC_withoutRH.temp[5];
            temp27 = cicloPCRC_withoutRH.temp[6];
            temp28 = cicloPCRC_withoutRH.temp[7];
            temp29 = cicloPCRC_withoutRH.temp[8];
            temp210 = cicloPCRC_withoutRH.temp[9];
            temp213 = cicloPCRC_withoutRH.temp[10];
            temp214 = cicloPCRC_withoutRH.temp[11];

            pres21 = cicloPCRC_withoutRH.pres[0];
            pres22 = cicloPCRC_withoutRH.pres[1];
            pres23 = cicloPCRC_withoutRH.pres[2];
            pres24 = cicloPCRC_withoutRH.pres[3];
            pres25 = cicloPCRC_withoutRH.pres[4];
            pres26 = cicloPCRC_withoutRH.pres[5];
            pres27 = cicloPCRC_withoutRH.pres[6];
            pres28 = cicloPCRC_withoutRH.pres[7];
            pres29 = cicloPCRC_withoutRH.pres[8];
            pres210 = cicloPCRC_withoutRH.pres[9];
            pres213 = cicloPCRC_withoutRH.pres[10];
            pres214 = cicloPCRC_withoutRH.pres[11];
        ...
        {
            PCRC_without_ReHeating_Optimization_Analysis_Results PCRC_without_ReHeating_Optimization_Analysis_Results_window = new PCRC_without_ReHeating_Optimization_Analysis_Results(this);
            PCRC_without_ReHeating_Optimization_Analysis_Results_window.Show();
        }
    }
}
