        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked == false)
            {
                ...
                if (puntero_aplicacion.comboBox1.Text == "NewMixture")
                {
                    ...
                    puntero_aplicacion.luis.core1(puntero_aplicacion.comboBox5.Text + "=" + puntero_aplicacion.textBox31.Text + "," + puntero_aplicacion.comboBox4.Text + "=" + puntero_aplicacion.textBox36.Text + "," + puntero_aplicacion.comboBox7.Text + "=" + puntero_aplicacion.textBox67.Text, puntero_aplicacion.category);
                ...
                xlWorkSheet1.Name = puntero_aplicacion.comboBox5.Text + " Mixture";

                xlWorkSheet1.Cells[1, 1] = puntero_aplicacion.comboBox5.Text + ":" + puntero_aplicacion.textBox31.Text + "," + puntero_aplicacion.comboBox4.Text + ":" + puntero_aplicacion.textBox36.Text + "," + puntero_aplicacion.comboBox7.Text + ":" + puntero_aplicacion.textBox67.Text;
